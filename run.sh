...
# dbuck_sizes
dbuck_sizes="64 128 256 512 1024 2048 4096"
...
#                 ./release/microbench --keys_file=./datasets/${dataset} --keys_file_type=binary --read=${ratio%:*} --insert=${ratio#*:} --operations_num=100000000 --table_size=200000000 --init_table_ratio=0.25 --thread_num=1 --index=buckindex --memory --bli_sbuck_size=${sbuck_size} --bli_dbuck_size=${dbuck_size}
#             done
#         done
#     done
# done
...
# ./release/microbench --keys_file=./datasets/books --keys_file_type=binary --read=0 --insert=1 --operations_num=10000000 --table_size=20000000 --init_table_ratio=0.5 --thread_num=1 --index=buckindex --memory --bli_sbuck_size=8 --bli_dbuck_size=256
